...
mysql_query("CREATE DATABASE sign_in",$con);

mysql_select_db("sign_in");
...
$body = "Hi,\n\nThanks for signing up !!! Discover yourself!$link  Activate your account within a period of 5 days. If not, you will have to sign-up again.";
...
in creating the account. Please read the Terms and Conditions to know more";
